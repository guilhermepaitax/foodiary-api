...
export function getImagePrompt() {
  return dedent`
    ...
    # Instructions
    Your task is:
    - Accurately identify the foods presents in the image;
    - Never try to guess, only detect what you are sure;
    - Estimate de amount of each item in grams, based on visual inspection and eventtual ambient reference (like keys, chairs, utensils, etc.);
    ...
    # Reasoning Steps
    1. Detect the foods in the picture without gueessing;
    2. Estimate calories and macronutrients os each of the detected foods.
